...
function Inscription() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0a2218] text-white font-sans">
      ...
      {/* ─── GAUCHE : Formulaire ─── */}
      <div className="flex w-full flex-col justify-center px-6 py-12 md:w-1/2 lg:px-14 xl:px-20">
        <div className="mx-auto w-full max-w-md">
          ...
          <h2 className="text-2xl font-light text-[#f0ede4] mb-1">Créer un compte</h2>
          <p className="text-xs text-[rgba(240,237,228,0.45)] mb-8">
            Déjà membre ?{" "}
            <Link to="/connexion" className="text-[#5DCAA5] font-medium hover:text-[#3db88a] transition-colors">
              Connectez-vous
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="nom" className="block text-xs font-medium text-[rgba(240,237,228,0.55)] mb-1.5">
                  Nom
                </label>
                <input
              ...
              <div>
                <label htmlFor="prenom" className="block text-xs font-medium text-[rgba(240,237,228,0.55)] mb-1.5">
                  Prénom
                </label>
                <input
            ...
            {/* Mot de passe */}
            <div>
              <label htmlFor="password" className="block text-xs font-medium text-[rgba(240,237,228,0.55)] mb-1.5">
                Mot de passe
              </label>
              <input
            ...
            <button
              type="submit"
              className="w-full bg-[#1D9E75] hover:bg-[#0F6E56] text-white text-sm font-medium py-2.5 rounded-lg transition-colors duration-200 mt-1"
            >
              Créer mon compte →
            </button>
          </form>
      ...
      <div className="relative hidden md:flex w-1/2 items-center justify-center bg-gradient-to-br from-[#071a10] to-[#0e2d1e] overflow-hidden">
        ...
        <div className="relative z-10 text-center px-10">
          <div className="font-serif text-5xl text-[rgba(93,202,165,0.6)] mb-3 leading-loose" style={{ fontFamily: 'Amiri, serif', direction: 'rtl' }}>
            اقْرَأْ بِاسْمِ رَبِّكَ
          </div>
          <p className="text-xs text-[rgba(240,237,228,0.4)] italic mb-10">
